...
public class Array_2D_Subtraction {
    ...
    public int[][] arraySubtraction (int [][]arrA, int[][]arrB, int n, int m) {
        ...
        public static void main(String[] args){
            ...
            Array_2D_Subtraction obj = new Array_2D_Subtraction();
            ...
            int [][] add = obj.arraySubtraction(A,B,n,m);
